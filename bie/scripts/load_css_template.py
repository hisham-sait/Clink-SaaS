#!/usr/bin/env python3
"""
Script to load the BI Engine Theme CSS template into Superset.
...
def load_css_template():
    """Load the BI Engine Theme CSS template into Superset."""
    print("Loading BI Engine Theme CSS template...")
    
    # Path to the CSS template file
    css_file_path = Path("/app/css_templates/biengine_theme.css")
...
if __name__ == "__main__":
    try:
        ...
        print("4. Name it 'BI Engine Theme'")
        print("5. Copy and paste the CSS from css_templates/biengine_theme.css")
