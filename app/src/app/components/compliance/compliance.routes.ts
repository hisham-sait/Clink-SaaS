...
export const COMPLIANCE_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'regulatory',
        loadComponent: () => import('./regulatory/regulatory.component').then(m => m.RegulatoryComponent),
        title: 'Regulatory Compliance',
        data: { section: 'compliance' }
      },
      {
        path: 'filing',
        loadComponent: () => import('./filing/filing.component').then(m => m.FilingComponent),
