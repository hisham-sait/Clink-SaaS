...
@Component({
  selector: 'app-create-allotment-modal',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, NgbModule],
  template: `
    <div class="modal-header">
      <h5 class="modal-title">Add New Share Allotment</h5>
...
export class CreateAllotmentModalComponent {
  ...
  constructor(
    ...
    this.allotmentForm = this.fb.group({
      ...
      allotmentDate: [new Date().toISOString().split('T')[0], Validators.required],
