...
@Component({
  selector: 'app-edit-share-modal',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, NgbModule],
  template: `
    <div class="modal-header">
      <h5 class="modal-title">Edit Share Class</h5>
      ...
      <form [formGroup]="shareForm" class="row g-3">
        ...
        <div class="col-md-6">
          <div class="form-check mt-4">
            <input class="form-check-input" type="checkbox" [checked]="shareForm.get('status')?.value === 'Active'" 
...
export class EditShareModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.share) {
      this.shareForm.patchValue(this.share);
    }
  }
  ...
  onSubmit(): void {
    if (this.shareForm.valid) {
      ...
      this.activeModal.close(updatedShare);
    } else {
