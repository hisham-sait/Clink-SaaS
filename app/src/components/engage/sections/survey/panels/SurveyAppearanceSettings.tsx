...
const SurveyAppearanceSettings: React.FC<SurveyAppearanceProps> = ({ appearance, onChange }) => {
  ...
  return (
    <div className="survey-appearance-settings" style={styles.container}>
      <div className="d-flex align-items-center mb-2">
        <FaPalette className="me-2" />
        <h6 className="mb-0" style={styles.header}>Survey Appearance</h6>
      </div>
      ...
      <Form>
        <Row style={styles.row}>
          <Col md={6}>
            <Form.Group style={styles.formGroup}>
              <Form.Label style={styles.label}>Survey Width</Form.Label>
              <Form.Select
                name="width"
              ...
              <Form.Text className="text-muted" style={styles.helpText}>
                Controls the maximum width of the survey
              </Form.Text>
            </Form.Group>
          </Col>
          <Col md={6}>
        ...
        <Row style={styles.row}>
          ...
          <Col md={6}>
            <Form.Group style={styles.formGroup}>
              <Form.Label style={styles.label}>Question Spacing</Form.Label>
              <Form.Control
                type="text"
