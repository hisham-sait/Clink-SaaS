...
const FormAppearanceSettings: React.FC<FormAppearanceProps> = ({ appearance, onChange }) => {
  ...
  return (
    <div className="form-appearance-settings" style={styles.container}>
      <div className="d-flex align-items-center mb-2">
        <FaPalette className="me-2" />
        <h6 className="mb-0" style={styles.header}>Form Appearance</h6>
      </div>
        ...
        <Row style={styles.row}>
          <Col md={6}>
            <Form.Group style={styles.formGroup}>
              <Form.Label style={styles.label}>Form Width</Form.Label>
              <Form.Select
                name="width"
...
export default FormAppearanceSettings;
