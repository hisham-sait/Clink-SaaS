...
const RadioElement: React.FC<RadioElementProps> = ({ onAdd, size = 'normal' }) => {
  return (
    <Card 
      onClick={() => onAdd('radio')}
    ...
    >
      <Card.Body className="text-center p-2">
        <div className="element-icon"><FaDotCircle /></div>
        <div className="element-label">Radio</div>
      </Card.Body>
    </Card>
  );
};

// Default properties for a radio element
export const getRadioProperties = (): Partial<FormElement> => {
  return {
    type: 'radio',
    label: 'Radio Group',
    required: false,
...
// Render the properties UI for a radio element
export const renderRadioPropertiesUI = (
  element: FormElement, 
