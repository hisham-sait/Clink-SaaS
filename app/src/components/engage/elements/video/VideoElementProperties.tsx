...
interface VideoElementPropertiesProps {
  element: VideoElementData;
  onChange: (updatedElement: VideoElementData) => void;
  companyId?: string;
}

/**
 * Container component for all video element property sections
 */
const VideoElementProperties: React.FC<VideoElementPropertiesProps> = ({
  element,
  onChange,
  companyId = '1'
}) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    console.log('VideoElementProperties handleChange:', { name, value, type });
    ...
    if (name === 'element' && typeof value === 'object') {
      ...
      onChange(value as VideoElementData);
  ...
  return (
    <div style={styles.container} data-testid="video-element-properties" className="compact-properties">
      {/* Video Preview Section */}
      <CollapsibleSection title="Video Preview" defaultExpanded={true}>
        <VideoPreview element={element} showTitle={false} />
      </CollapsibleSection>
